...
/** Renders a definition term + body pair inside the definitions list. */
      ...
      <div className="mx-auto w-full max-w-3xl">
        ...
        <header className="mt-6 flex items-start gap-4">
          <span className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-brand/10">
            <ShieldCheck size={22} aria-hidden="true" className="text-brand" />
          </span>
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-brand">finsave ai</p>
            <h1 className="mt-1 text-3xl font-semibold tracking-tight sm:text-4xl">Privacy Policy</h1>
            <p className="mt-1 text-sm text-ink/55">Last updated: August 10, 2026</p>
          </div>
        </header>
        ...
        <p className="mt-4 text-sm leading-relaxed text-ink/70">
          We use Your Personal Data to provide and improve the Service. We collect, use, and disclose
          Your information as described in this Privacy Policy and, where required by applicable law,
          only where We have a valid legal basis to do so, including Your consent (where consent is
          required). This Privacy Policy has been created with the help of the Privacy Policy
          Generator.
        </p>
        ...
        <nav
          ...
          className="card-inner mt-8 p-5 sm:p-6"
        >
          ...
          <section id="interpretation-definitions" className="scroll-mt-8">
            ...
            <ul className="mt-3 flex flex-col gap-4">
              ...
              <Term name="Affiliate">
                ...
                party, where &ldquo;control&rdquo; means ownership of 50% or more of the shares,
                equity interest or other securities entitled to vote for election of directors or
                other managing authority.
              </Term>
              <Term name="Company">
                (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo;
                or &ldquo;Our&rdquo; in this Privacy Policy) refers to finsave ai.
              </Term>
              <Term name="Cookies">
              ...
              <Term name="Personal Data">
                ...
                identified or identifiable individual. We use &ldquo;Personal Data&rdquo; and
                &ldquo;Personal Information&rdquo; interchangeably unless a law uses a specific term.
              </Term>
          ...
          <section id="collecting-data" className="scroll-mt-8">
            ...
            <ul className="mt-2 flex flex-col gap-4">
              ...
              <Term name="Web Beacons">
                Certain sections of Our Service may contain small electronic files known as web
                beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that
                permit the Company, for example, to count users who have visited those pages and for
            ...
            <ul className="mt-3 flex flex-col gap-4">
              <li className="rounded-xl border border-neutral-200 bg-neutral-50/50 p-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-ink/70">
                  <span className="font-medium text-ink/80">Purpose:</span> These Cookies are
                  ...
                  fraudulent use of user accounts. Without these Cookies, the services that You have
              ...
              <li className="rounded-xl border border-neutral-200 bg-neutral-50/50 p-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-ink/70">
                  ...
                  whether users have accepted the use of cookies on the Website and record the
                  consent choices You have made, so that We can honor those choices on future visits.
                </p>
              </li>
              <li className="rounded-xl border border-neutral-200 bg-neutral-50/50 p-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-ink/70">
                  ...
                  Account login details or language preference. The purpose of these Cookies is to
            ...
            <ul className="mt-2 flex flex-col gap-3">
              ...
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">To manage Your Account:</span> to manage
              ...
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">For the performance of a contract:</span>{' '}
              ...
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">To contact You:</span> To contact You by
              ...
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">To provide You with news, special offers,
                and general information</span> about other goods, services and events which We offer
                that are similar to those that You have already purchased or inquired about. We send
                such marketing communications only where permitted by applicable law: where prior
                consent is required (for example, under the laws applicable in the EEA and the UK),
                We will send them only with Your consent; otherwise, We may send them until You opt
                out. You may opt out or withdraw Your consent at any time by using the unsubscribe
                link in any marketing email We send or by contacting Us.
              </li>
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">To manage Your requests:</span> To attend
                and manage Your requests to Us.
              </li>
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">For business transfers:</span> We may use
                Your Personal Data to evaluate or conduct a merger, divestiture, restructuring,
            ...
            <ul className="mt-2 flex flex-col gap-3">
              <li className="text-sm leading-relaxed text-ink/70">
                ...
                Your Personal Data with Service Providers to monitor and analyze the use of Our
                Service, and to contact You.
              </li>
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">For business transfers:</span> We may share
                or transfer Your Personal Data in connection with, or during negotiations of, any
              ...
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">With other users:</span> If Our Service
                offers public areas, when You share Personal Data or otherwise interact in the public
                areas with other users, such information may be viewed by all users and may be
                publicly distributed outside the Service.
              </li>
              <li className="text-sm leading-relaxed text-ink/70">
                <span className="font-medium text-ink/80">With Your consent:</span> We may disclose
            ...
            <p className="mt-2 text-sm leading-relaxed text-ink/70">
              ...
              messages, We will send You updates, notifications, and other communications as
              described below. When You opt in, We will collect and store the information You provide
              in connection with text messaging, such as Your phone number, the date and method of
              Your consent, and message delivery and read information.
            </p>
            <p className="mt-3 text-sm leading-relaxed text-ink/70">
            ...
            <p className="mt-3 text-sm leading-relaxed text-ink/70">
              ...
              periods below are maximum periods (&ldquo;up to&rdquo;) and We may delete or anonymize
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-relaxed text-ink/70">
              <li>
                <span className="font-medium text-ink/80">Legal obligation:</span> We are required by
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-relaxed text-ink/70">
              <li>
                <span className="font-medium text-ink/80">Deletion:</span> Personal Data is removed
                from Our systems and no longer actively processed.
              </li>
              <li>
                <span className="font-medium text-ink/80">Backup retention:</span> Residual copies
                may remain in encrypted backups for a limited period consistent with Our backup
                retention schedule and are not restored except where necessary for security, disaster
                recovery, or legal compliance.
              </li>
              <li>
                <span className="font-medium text-ink/80">Anonymization:</span> In some cases, We
                convert Personal Data into anonymous statistical data that cannot be linked back to
                You. This anonymized data may be retained indefinitely for research and analytics.
              </li>
            </ul>
            ...
            <p className="mt-3 text-sm leading-relaxed text-ink/70">
              If You are a parent or guardian and You believe Your child has provided Us with
              Personal Information, please contact Us. If We become aware that We have collected
              Personal Information from anyone under the age of 16, We will take steps to remove that
            ...
            <p className="mt-3 flex items-center gap-2 text-sm leading-relaxed text-ink/70">
              ...
              <span>
                By email:{' '}
                <a
                  href="mailto:no-reply@aitoolshq.space"
                  className="font-medium text-brand outline-none rounded transition-colors duration-200 hover:text-brand-deep focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                >
